...
// isso faz com que o código fique completamente ajustável nesses aspectos
public class Configuracao {
    ...
    public int consumoEnergiaDeslocamento = 2;
    public int consumoEnergiaParada = 1;
    public int pesoMaximoElevador = 1000;
}
